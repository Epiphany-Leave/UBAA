...
## 2026-09-20 Graduate academic extraction

See [operation-level source comparison](evidence/2026-09-20-graduate-academic.md). Identity isolation replaces probing/fallback; existing undergraduate endpoint contracts remain unchanged.
